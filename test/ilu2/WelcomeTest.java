...
class WelcomeTest {
	...
	@Test
	void testWelcom7() {
		assertEquals("Hello, Amy, Jerry and Morty. AND HELLO, BOB !", Welcome.welcome("amy,BOB,jerry, morty"));
		assertEquals("Hello, Amy and Jerry. AND HELLO, BOB, MARS AND MERLIN !", Welcome.welcome("amy,BOB  ,   jerry, MARS, MERLIN"));
	}
